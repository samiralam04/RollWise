...
### 📝 Smart Excuse Letter System

- **Digital Submission**: Students upload medical certificates or other documents directly via dashboard.
- **OCR & AI Analysis**: Automatic text extraction from uploaded images/PDFs using Tesseract OCR.
- **Auto-Categorization**: AI suggests category (Medical, Family, Personal) based on content.
- **Teacher Workflow**: Review interface with Approve, Reject, and **Hold** options.
...
- **Excuse Management**: Review, Approve, Reject, or Hold student excuse letters with AI insights.
...
- **Excuse Submission**: Easy-to-use form for submitting absence excuses with medical document upload.
...
- **Tesseract OCR** - Optical Character Recognition for document parsing.
- **Pillow (PIL)** - Image processing helper.
